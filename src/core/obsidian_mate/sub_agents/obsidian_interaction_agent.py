...
obsidian_interaction_agent = Agent(
    name=AgentNameEnum.OBSIDIAN_INTERACTION_AGENT,
    ...
    instruction=template_parser.get("interact_obsidian", "INSTRUCTIONS"),  # type: ignore
    tools=[
        obsidian_tool
    ],
)
